...
void uart_init(unsigned int ubrr) {
	...
	UBRR0L = (unsigned char)(ubrr);
		// UBRRO : 16 bits register but ubrr coded in 12bits (4bits reserved for other stuff in the board)
			// >> 8 to keep high bit and store on UBBROHigh
			// keep low bit on UBBROLow



	// DATASHEET PAGE 200 SECTION 20.11.2
	//mode double speed
	UCSR0A = (1 << U2X0);


	//DATASHEET PAGE 201 SECTION 20.11.3
	...
	//DATASHEET  PAGE 202 SECTION 20.11.4
	// 115200 8N1
	...
	UCSR0C = (1 << UCSZ01) | (1 << UCSZ00);
		...
		// UPM01 and UPM02: handle parity bit
		// UCSZ00 : 3 == 11 (base2)
